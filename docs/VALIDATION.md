...
Settings writes, alarm changes, concurrent phone sessions and complete firmware support remain unverified. No running user HA instance was modified. See LIVE_TEST.md for those remaining checks.
